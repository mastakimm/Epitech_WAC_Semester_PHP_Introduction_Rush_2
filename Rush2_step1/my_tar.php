...
// Parcourir les arguments du terminal
for ($i = 1; $i < $argc; $i++) {
    $input = $argv[$i];
    if (is_dir($input)) {
        // Si l'argument est un répertoire, ajoute tous les fichiers et sous-répertoires au .tar
...
// Fonction pour ajouter un fichier au .tar
